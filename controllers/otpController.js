...
const sendEmail = require("../utils/emailService"); // Make sure you have this utility
...
exports.sendOTP = async (req, res) => {
  try {
    ...
    if (!email) {
      console.log("⚠️ Email is missing in request");
      return res
        .status(400)
    ...
    res.json({
      ...
      // debugOtp: otp  // Uncomment only for dev/debugging
    });
  } catch (error) {
